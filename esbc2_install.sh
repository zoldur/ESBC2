...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='esbcoin.conf'
CONFIGFOLDER='/root/.esbcoin'
COIN_DAEMON='esbcoind'
COIN_CLI='esbcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/BlockchainFor/ESBC2/releases/download/2.0.3.2/esbcoin-cli_ubuntu-16.04-x64.tar.bz2'
